 ...
 */
          ...
          if (__pyx_t_4 < 0) {
            __pyx_t_4 += __pyx_v_flux.shape[0];
            if (unlikely(__pyx_t_4 < 0)) __pyx_t_15 = 0;
          } else if (unlikely(__pyx_t_4 >= __pyx_v_flux.shape[0])) __pyx_t_15 = 0;
          if (__pyx_t_14 < 0) {
 ...
 */
          ...
          __pyx_t_18 = __pyx_v_og;
          __pyx_t_15 = -1;
          if (__pyx_t_16 < 0) {
            __pyx_t_16 += __pyx_v_xs_fission.shape[0];
            if (unlikely(__pyx_t_16 < 0)) __pyx_t_15 = 0;
          } else if (unlikely(__pyx_t_16 >= __pyx_v_xs_fission.shape[0])) __pyx_t_15 = 0;
          if (__pyx_t_17 < 0) {
            __pyx_t_17 += __pyx_v_xs_fission.shape[1];
            if (unlikely(__pyx_t_17 < 0)) __pyx_t_15 = 1;
          } else if (unlikely(__pyx_t_17 >= __pyx_v_xs_fission.shape[1])) __pyx_t_15 = 1;
          if (__pyx_t_18 < 0) {
            __pyx_t_18 += __pyx_v_xs_fission.shape[2];
            if (unlikely(__pyx_t_18 < 0)) __pyx_t_15 = 2;
 ...
 */
          ...
          __pyx_t_19.memview = __pyx_v_power_source.memview;
...
__pyx_t_20.data = __pyx_t_19.data;
          ...
          if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_20,
    __pyx_t_19.shape[0], __pyx_t_19.strides[0], __pyx_t_19.suboffsets[0],
    0,
    0,
    &__pyx_t_15,
    __pyx_v_angle,
 ...
 */
    ...
    __pyx_t_5 = -1;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_v_power_source.shape[0];
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("ants.cyutils.add_manufactured_source", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
