...
static double __pyx_f_4ants_8x_sweeps_right_to_left(__Pyx_memviewslice &, __Pyx_memviewslice &, __Pyx_memviewslice &, __Pyx_memviewslice &, __Pyx_memviewslice &, __Pyx_memviewslice &, __Pyx_memviewslice &, __Pyx_memviewslice &, double, double, double, __Pyx_memviewslice &, double); /*proto*/
 ...
 */
    ...
    0,
    &__pyx_t_3,
    (__pyx_v_gg + (__pyx_v_nn * (*((int *) ( /* dim=0 */ (__pyx_v_params.data + __pyx_t_2 * __pyx_v_params.strides[0]) ))))),
    0,
 ...
 */
    ...
    0,
    &__pyx_t_3,
    (__pyx_v_gg + (__pyx_v_nn * (*((int *) ( /* dim=0 */ (__pyx_v_params.data + __pyx_t_6 * __pyx_v_params.strides[0]) ))))),
    0,
