...
#                    /_/  |_/_/ |_/ /_/  /____/
#
# Two dimensional method of manufactured solutions problem with no
# scattering, 1/2 unit external source, and incoming boundary sources.
# Solution 01: exponential decay in x only, independent of y.
#
########################################################################
...
sources = SourceData(
    external=0.5 * np.ones((cells_x, cells_y, 1, 1)),
...
exact = mms.solution_ss_01(centers_x, centers_y, quadrature.angle_x, quadrature.angle_y)
...
fig.suptitle("2D Manufactured Solution 01")
plt.tight_layout()
plt.show()
