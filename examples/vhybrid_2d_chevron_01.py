...
groups_c = np.array([groups_c] * steps, dtype=np.int32)
angles_c = np.array([angles_c] * steps, dtype=np.int32)

# # Run Hybrid
# flux = vhybrid2d.tr_bdf2(groups_c, angles_c, initial_x, \
#                     initial_y, xs_total_u,  xs_scatter_u, xs_fission_u, \
#                     velocity_u, external, boundary_x, boundary_y, medium_map, \
#                     delta_x, delta_y, angle_xu, angle_yu, angle_wu, \
#                     edges_g, info_u, info_c)
...
if __name__ == "__main__":
    ...
    with open("vhybrid-memory-usage.txt", "a") as f:
        f.write(
